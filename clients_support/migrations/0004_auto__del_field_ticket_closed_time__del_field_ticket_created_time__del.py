...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Ticket.closed_time'
        db.delete_column(u'clients_support_ticket', 'closed_time')

        # Deleting field 'Ticket.created_time'
        db.delete_column(u'clients_support_ticket', 'created_time')

        # Deleting field 'Ticket.updated_time'
        db.delete_column(u'clients_support_ticket', 'updated_time')

        # Adding field 'Ticket.created_at'
        db.add_column(u'clients_support_ticket', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 10, 25, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Ticket.updated_at'
        db.add_column(u'clients_support_ticket', 'updated_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 10, 25, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Ticket.closed_at'
        db.add_column(u'clients_support_ticket', 'closed_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Ticket.closed_time'
        db.add_column(u'clients_support_ticket', 'closed_time',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Ticket.created_time'
        db.add_column(u'clients_support_ticket', 'created_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 10, 25, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Ticket.updated_time'
        db.add_column(u'clients_support_ticket', 'updated_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2013, 10, 25, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'Ticket.created_at'
        db.delete_column(u'clients_support_ticket', 'created_at')

        # Deleting field 'Ticket.updated_at'
        db.delete_column(u'clients_support_ticket', 'updated_at')

        # Deleting field 'Ticket.closed_at'
        db.delete_column(u'clients_support_ticket', 'closed_at')
    ...
    models = {
        ...
        u'clients_support.ticket': {
            ...
            'user_mark': ('django.db.models.fields.CharField', [], {'default': "'not_rated'", 'max_length': '15'}),
